...
func GetTheme(themeName string) UITheme {
	...
	case "mono", "minimal", "plain":
		// Monochrome / Minimalist Theme with very few colors
		return UITheme{
			Primary:     style.Color("#ffffff"), // White
			Secondary:   style.Color("#ffffff"), // White
			Text:        style.Color("#ffffff"), // White
			Border:      style.Color("#555555"), // Muted Gray
			Success:     style.Color("#10b981"), // Green for success/done symbols
			Error:       style.Color("#ef4444"), // Red for error symbols
			Highlight:   style.Color("#ffffff"), // White
			ChromaStyle: "bw",                   // Black and white syntax highlighting
		}
	case "dark":
		fallthrough
	default:
